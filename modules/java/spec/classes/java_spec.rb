...
describe 'java', type: :class do
  ...
  context 'when select jdk for Ubuntu xenial (16.04) on ARM' do
    ...
    it { is_expected.to contain_file_line('java-home-environment').with_line('JAVA_HOME=/usr/lib/jvm/java-1.11.0-openjdk-armhf/') }
  end
  ...
  context 'when select jdk for Ubuntu xenial (16.04) on ARM64' do
    ...
    it { is_expected.to contain_package('java').with_name('openjdk-11-jdk') }
    it { is_expected.to contain_file_line('java-home-environment').with_line('JAVA_HOME=/usr/lib/jvm/java-1.11.0-openjdk-arm64/') }
  end
